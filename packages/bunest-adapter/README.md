...
Tested on MacOS Sequoia (15.6.1), Apple M1 Max (64GB RAM), Bun 1.3.5, Node.js 20.10.0. All benchmarks run using [`oha`](https://github.com/hatoo/oha) tool with the following command:
